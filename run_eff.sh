...
#SBATCH -o /home-mscluster/mkruger/GitHub/cgiar-zindi-crop-classification/logs/eff_fixed_train.%N.%j.out
# specify the filename for stderr
#SBATCH -e /home-mscluster/mkruger/GitHub/cgiar-zindi-crop-classification/logs/eff_fixed_train.%N.%j.err
